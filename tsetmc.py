...
import database
from Log import *
from converter import jalali_to_gregorian_int, gregorian_to_jalali_int
...
class Tsetmc:
    ...
    # -------------------
    def get_all_share_data(self):
        lock_status = False
        self.print_c('worker: {0} :{1}'.format(current_process().name, 'start get_all_share_data function'))
    ...
    # -------------------
    def get_all_index_daily_data(self, excel_path, mod=2):
...
def get_all_index_daily_data(tsetmc_obj, excel_path=tsetmc_excel_path, mod=2):
    tsetmc_obj.get_all_index_daily_data(excel_path, mod)
...
if __name__ == '__main__':
    ...
    a.get_all_index_daily_data(excel_path, mod=2)
